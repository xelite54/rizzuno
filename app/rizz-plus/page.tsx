    ...
    <main className={`${styles.page} h-dvh overflow-y-auto text-[#f5eff5]`}>
      ...
      <div className={styles.layout}>
        ...
        <section className={styles.details} aria-labelledby="membership-heading">
          ...
          {active && <Link href="/" className="mt-3 block rounded-xl border border-white/15 px-4 py-3 text-center text-[13px] text-[#e8cedf] hover:bg-white/5">Back to matching →</Link>}
