...
export function MicOffIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M9 9v3a3 3 0 0 0 4.6 2.55M15 6.5V5a3 3 0 0 0-5.9-.75" />
...
export function CameraIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      ...
      <path d="M16.5 10.5 21 7.75a.6.6 0 0 1 .9.52v7.46a.6.6 0 0 1-.9.52L16.5 13.5" />
    </svg>
  )
}
...
export function CameraOffIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M2.5 8.2V15a3 3 0 0 0 3 3h6.3" />
      <path d="M16.5 10.5 21 7.75a.6.6 0 0 1 .9.52v7.46a.6.6 0 0 1-.9.52L16.5 13.5" />
      <path d="M4.5 6h5.7a3 3 0 0 1 3 3v.3" />
      <path d="M3 3l18 18" />
    </svg>
  )
}
...
export function MaleIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      ...
      <path d="M15.5 3.5 20.5 3.5 20.5 8.5" />
    </svg>
  )
}
...
export function UsersIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      ...
      <path d="M2.75 19c.6-3.2 3.1-5 6.25-5s5.65 1.8 6.25 5" />
      <path d="M16 5.1a3.25 3.25 0 0 1 0 6.3" />
      <path d="M18.25 14.3c2.1.5 3.5 1.9 4 4.7" />
    </svg>
  )
}
