...
type ProfileActionsMenuProps = {
  ...
  /** Fired whenever the menu transitions to closed — by the "•••" toggle, or by a child calling `close()`. Lets a caller reset its own confirm-step state (Remove friend/Block's "are you sure?") so reopening the menu always starts back at the top level rather than wherever it was left. */
  onClose?: () => void
  /**
 ...
 * Remove friend, Block, Report — off the main body, the same way the friends
