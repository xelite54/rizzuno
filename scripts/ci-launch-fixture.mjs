...
const categories = Object.fromEntries(["friendMessages", "friendRequests", "reports", "moderationActions", "imageChecks", "legalAcceptance", "privacyOperations", "accountTombstones", "storedImages", "heldRecords", "infrastructureLogs", "backups"].map(category => [category, {
  mode: ["infrastructureLogs", "backups"].includes(category) ? "external" : category === "accountTombstones" ? "review" : "automatic",
